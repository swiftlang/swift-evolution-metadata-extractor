...
struct ExtractCommand: AsyncParsableCommand {
    ...
    func run() async throws {
        let extractionJob = try await ExtractionJob.makeExtractionJob(source: extractionSource, output: output, ignorePreviousResults: true, forcedExtractionIDs: forcedExtractionIDs)
